...
knitr::opts_chunk$set(cache=TRUE,message=FALSE,warning=FALSE,pdf.options(useDingbats=TRUE))
```
# Summary
...
```{r choroplethr, results='hide',message=FALSE}
...
```{r finale, results='hide',message=FALSE} 
